...
function Card({ contents, title, subTitle, description, h, inverse, downloadType }) {
    return (
            ...
            <div className = {`container mx-auto justify-self-center flex flex-col gap-8 max-md:gap-4 pt-24 max-md:pt-8`}>
                <div className = "flex justify-center w-full">
                    <div className = "flex flex-col gap-2 text-center w-lg">
                        <div className = {`flex justify-center items-center gap-2.5 ${inverse && "flex-row-reverse"}`}>
