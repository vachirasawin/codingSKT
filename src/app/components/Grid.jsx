...
function Grid({ data }) {
    ...
    return (
        <div className = "px-4 border-b border-[#ececec]">
            <div className = "container mx-auto justify-self-center py-24 max-md:py-4 flex items-center justify-start overflow-x-auto hide-scrollbar">
                <div className = "shadow-xl">
                    <div className = "flex">
                        <div className = "border border-r-0 border-[#9497a1] flex justify-center items-center gap-2 w-42 h-12 rounded-tl-xl">
                        ...
                        {data.map((data, index) => (
                            <div className = {`border border-[#9497a1] flex justify-center items-center gap-2 w-42 h-12 ${(index === dataLength - 1 && dataLength !== 1) && "rounded-tr-xl"}`} key = {`${index} - title`}>
                    ...
                    <div className = "flex">
                        <div className = "border border-r-0 border-[#9497a1] flex justify-center items-center gap-2 w-42 h-12">
                        ...
                        {data.map((data, index) => (
                            <div className = {`border border-[#9497a1] flex justify-center items-center gap-2 w-42 h-12`} key = {`${index} - lower`}>
                                {data.lower}
                            </div>
                        ))}
                    </div>
                    <div className = "flex">
                        <div className = "border border-[#9497a1] flex justify-center items-center gap-2 w-42 h-12 rounded-bl-xl">
                        ...
                        {data.map((data, index) => (
                            <div className = {`border border-[#9497a1] flex justify-center items-center gap-2 w-42 h-12  ${(index === dataLength - 1 && dataLength !== 1) && "rounded-br-xl"}`} key = {`${index} - upper`}>
                                {data.upper}
                            </div>
                        ))}
                    </div>
