                    ...
                    <div className = "container mx-auto justify-self-center flex flex-col gap-8 max-md:gap-4 pt-24 max-md:pt-8 justify-center items-center">
                        <div className = "flex justify-center w-full" data-aos = "fade-up">
                            <div className = "flex flex-col gap-2 text-center w-full justify-center items-center">
                                ...
                                <p className = "text-[#9497a1] text-lg max-md:text-sm w-lg max-sm:w-full">กล่องรีวิว</p>
                            </div>
                        </div>
                        <div className = "pb-24 max-md:pb-8 text-[#171717] w-full flex justify-center items-center max-md:flex-col" data-aos = "fade-up">
                            <div className = "h-16 w-16 bg-blue-500 flex rounded-l-xl justify-center items-center text-lg text-white font-medium max-md:hidden">
                                <i className = "fa-solid fa-inbox"></i>
                            </div>
                            <input type = "text" className = "h-16 max-md:h-12 flex justify-center items-start outline-none border-2 md:border-x-0 max-md:rounded-t-xl max-md:border-b-0 border-[#ececec] w-lg max-md:w-full px-6 text-lg font-medium"/>
                            <div className = "flex max-md:flex-row md:flex-row w-full md:w-auto">
                                ...
                                <div className = "h-16 w-16 max-md:h-12 max-md:w-1/2 bg-[#171717] md:rounded-r-xl max-md:rounded-br-xl flex justify-center items-center text-lg text-white font-medium">
