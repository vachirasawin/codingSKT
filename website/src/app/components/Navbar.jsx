...
function Navbar({ home, signIn, signUp, addInfo, profile, dashboard, aboutUs, userGuide, privacyPolicy, ourTeam, news, faq, models, linearRegression, polynomialRegression, regularizedLinearRegressionRidge, decisionTreeRegression, admin, dataset }) {
