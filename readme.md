...
- [numpy](https://numpy.org/): Library สำหรับคำนวณทางคณิตศาสตร์และตรรกะกับ Array
...
- [mean_absolute_error (MAE)](https://scikit-learn.org/stable/modules/generated/sklearn.metrics.mean_absolute_error.html): Function สำหรับวัดความคลาดเคลื่อนเฉลี่ยสัมบูรณ์ระหว่างค่าจริงกับค่าพยากรณ์
- [mean_squared_error (MSE)](https://scikit-learn.org/stable/modules/generated/sklearn.metrics.mean_squared_error.html): Function สำหรับวัดความคลาดเคลื่อนเฉลี่ยยกกำลังสองระหว่างค่าจริงกับค่าพยากรณ์
